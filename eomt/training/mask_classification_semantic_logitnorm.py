...
from training.mask_classification_loss_logitnorm import LogitNormMaskClassificationLoss
from training.lightning_module import LightningModule


class MaskClassificationSemanticLogitNorm(LightningModule):
    def __init__(
        self,
        network: nn.Module,
        ...
        # Instantiate the LogitNormMaskClassificationLoss (logit normalization loss is used for fine-tuning)
